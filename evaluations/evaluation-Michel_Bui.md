...
- être plus pragmatique dans les informations à l'écrit du cachier des charges même si les principales idées sont données. Il faut mettre dans le cahier des charges certains exemples pour illustrer devraient être énumérés entre parenthèses à côté des explications afin de rendre plus facile la prise en main par la suite.
          
-  la description des fonctionnalités étaient incomplètes : "Barre de réussite des projets : Barre de financement des projets :" ne montrent pas comment elles fonctionnent (la description est vide après les :). Rien est expliqué ici au testeur. Faîtes en sorte que ce soit plus clair pour l'utilisateur !

# Propositions d'amélioration du jeu

- Respecter la taille des composants selon l'échelle de l'écran du jeu (image excel trop petit), ce qui empêche à l'utilisateur de jouer et de faire ses choix si il accepte ou pas la qualité du projet.

- Mettre un menu avec des options et un tutoriel (guide, volume...), car ici il n'y avait quasiment aucun bouton, à part le bouton intéragir avec le personnage qui était mal placé sur l'écran, ce qui rendait compliqué les intéractions avec les personnages du jeu.
