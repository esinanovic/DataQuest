...
- Dans la partie "Description et fonctionnalités", cela sera mieux de les mettres ligne par ligne au lieux de les laisser collé un à côté de l'autre.
- Ajouter plus d'information dans "Fonctionnalités et scénarios avancés"

# Propositions d'amélioration du jeu

- Terminer le jeu
- Mettre un tutoriel au début
...
Justifications :
-Les fichier sont bien rangé selon les critères
-Les commit sont bien commenté et chaque personne a presque le même nombre de commit
-Julien Gossa est bien le owner et ce dépôt est accessible
...
Un jeu facile à comprendre, mais à cause des problèmes et du manque de temps ils n'ont pas términé le jeu donc le jeu est resté juste comme un prototype.
J'ai appris comment les endroits de recherche fonctionne avec les rechercheurs. C'est pas mal.

Autres justifications :
Le jeu est démonstré sous linux donc cela ne s'installe pas sur mon pc
...
- Captures d'écran
  ...
  - [x] Aucune capture d'écran n'est donnée.
