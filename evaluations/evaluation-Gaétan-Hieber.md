...
- Proposition 1
  revoir un peu la syntaxe de certaines phrases pour que ce soit plus explicite.
- Proposition 2
  Commencer le md par un message plus accrocheur
- Proposition 3
  pas de propisition supplémentaire, le readme est correct

# Propositions d'amélioration du jeu

- Proposition 1
  Mettre moins d'éléments dans le décors pour faire mieux apparaitre les personnages
- Proposition 2
  agrandir la taille des images dans les intéractions, on ne voit rien sur les screens des excels
- Proposition 3
  Mettre un message explicatif au début du jeu
...
Justifications :
Le problème est que le Git est nouveau, les membres l'ont changé récemment. C'est donc difficile d'évaluer les commits quand il y en a 3. Les fichiers sources sont correctement nommés mais certains noms auraient pu être plus explicites ou retravaillés.
...
J'ai appris ce que c'était qu'un data librarian et sa fonction, quelle est son utilité.

Autres justifications :
Quand on arrive dans le jeu on n'a aucune indication, il faut lire le README ou écouter les développeurs pour tout comprendre. Sinon la prise en main est simple et le jeu est très fluide.
